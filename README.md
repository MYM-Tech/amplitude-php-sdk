...
[//]: # ([![Coverage Status]&#40;https://coveralls.io/repos/github/MYM/amplitude-php/badge.svg?branch=master&#41;]&#40;https://coveralls.io/github/MYM-Tech/amplitude-php?branch=master&#41;)

[//]: # ([![Scrutinizer]&#40;https://scrutinizer-ci.com/g/MYM-Tech/amplitude-php/badges/quality-score.png?b=master&#41;]&#40;https://scrutinizer-ci.com/g/MYM-Tech/amplitude-php/&#41;)
...
$amplitude = \MYM\Amplitude\Amplitude::getInstance();
...
\MYM\Amplitude\Amplitude::getInstance()
...
<?php
$amplitude = new \MYM\Amplitude\Amplitude();
...
\MYM\Amplitude\Amplitude::getInstance()->queueEvent('EVENT');
...
$event = \MYM\Amplitude\Amplitude::getInstance()->event();
...
\MYM\Amplitude\Amplitude::getInstance()->queueEvent();
```
...
\MYM\MYM\Amplitude::getInstance()->event(
    [
